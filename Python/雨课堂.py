...
class WangKe:
    ...
    def get_list(self,url,location):
        ...
        with open(location,'w+') as fp:
            ...
            try:
                while 1:
                    # next_button = self.wd.find_element_by_xpath('//*[@id="app"]/div[2]/div[2]/div[3]/div/div/div[1.py]/div/div[3]/button[2]')
    ...
    def watching_letter(self, url ):
        ...
        try:
            ...
            try:
                time_persent = wd.find_element_by_xpath('//*[@id="app"]/div[2]/div[2]/div[3]/div/div[2]/div[1.py]/section[1.py]/div[2]/div/div/span').text
            except:
                time_persent = None
            finally:
                print('==============================================================================================')
                ...
                if (not '随堂作业' in homework_text) and ( not '100%' in time_persent):
                    try:
                        ...
                        if button:
                            ...
                            speed_2 = wd.find_element_by_xpath('//*[@id="video-box"]/div/xt-wrap/xt-controls/xt-inner/xt-speedbutton/xt-speedlist/ul/li[1.py]')
