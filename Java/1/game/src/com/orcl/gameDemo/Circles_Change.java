        ...
        class 面板 extends JPanel {
            ...
            public void paint(Graphics g) {
                ...
                for (int i = 0; i < CircleNum; i++) {
                    g.drawOval(10 * i, 10 * i, 300 - i * 20, 300 - i * 20);
            ...
            while (true) {
                try {
                   ...
                   //1.先判断波纹状态
                    if (this == ds1) {
                        //TODO d1定时处理
                        if (CircleNum == 15)//波纹向外 圆圈变少
                            flag = true;
                        else if (CircleNum == 0)//波纹向内 圆圈变多
                            flag = false;
                    //1.根据状态控制圆圈变多、变少
                        CircleNum=flag? CircleNum-1:CircleNum+1;
                    */
                    //-----法二-----
                    //1.先判断圆圈的状态
                    //2.在圆圈状态中控制圆圈数量
