    ...
    class 窗口 extends JFrame {
        ...
        class 面板 extends JPanel {
            ...
            public void paint(Graphics g) {
                ...
                //TODO c绘图在此
                Image blue = new ImageIcon("宝石图/宝石/blue.png").getImage();
                Image green = new ImageIcon("宝石图/宝石/green.png").getImage();
                Image red = new ImageIcon("宝石图/宝石/red.png").getImage();
                Image yellow = new ImageIcon("宝石图/宝石/yellow.png").getImage();
                Image color=blue;
                for (int h = 0; h < 10; h++) {
                    for (int l = 0; l < 10; l++) {
                        switch ((h + l) % 4) {
                        ...
                        g.drawImage(color, l*50,h*50 , null);
                    }
                }
