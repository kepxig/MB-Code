    ...
    class 窗口 extends JFrame {
        ...
        class 面板 extends JPanel {
            ...
            public void paint(Graphics g) {
                ...
                //TODO c绘图在此
                /*Image a1 = new ImageIcon("fox/0-0.png").getImage();
                Image b1 = new ImageIcon("fox/0-1.png").getImage();
                Image c1 = new ImageIcon("fox/0-2.png").getImage();
                Image d1 = new ImageIcon("fox/0-3.png").getImage();
                Image a2 = new ImageIcon("fox/1-0.png").getImage();
                Image b2 = new ImageIcon("fox/1-1.png").getImage();
                Image c2 = new ImageIcon("fox/1-2.png").getImage();
                Image d2 = new ImageIcon("fox/1-3.png").getImage();
                Image a3 = new ImageIcon("fox/2-0.png").getImage();
                Image b3 = new ImageIcon("fox/2-1.png").getImage();
                Image c3 = new ImageIcon("fox/2-2.png").getImage();
                Image d3 = new ImageIcon("fox/2-3.png").getImage();
                Image a4 = new ImageIcon("fox/3-0.png").getImage();
                Image b4 = new ImageIcon("fox/3-1.png").getImage();
                Image c4 = new ImageIcon("fox/3-2.png").getImage();
                Image d4 = new ImageIcon("fox/3-3.png").getImage();
                */
                /*
                g.drawImage(a1, 0, 0, null);
                g.drawImage(b1, 70, 0, null);
                g.drawImage(a2, 0, 100, null);
                */
                Image [][]fox=new Image[4][4];//采用图片数组
                for (int i = 0; i < 4; i++) {
                    for (int j = 0; j < 4; j++) {
                        fox[i][j] = new ImageIcon("fox/" + i + '-' + j + ".png").getImage();
                        g.drawImage(fox[i][j], j * 80, i * 100, null);
