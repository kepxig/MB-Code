    ...
    class 窗口 extends JFrame {
        ...
        class 面板 extends JPanel {
            ...
            public void paint(Graphics g) {
                ...
                //TODO c绘图在此
                Image[][] poker = new Image[5][14];//采用图片数组
                for (int i = 1; i < 5; i++) {
                    for (int j = 1; j < 14; j++) {
                        poker[i][j] = new ImageIcon("扑克图Q版/" + j + '-' + i + ".png").getImage();
                        g.drawImage(poker[i][j], (j - 1) * 30, (i - 1) * 130, null);
                    }
                }

                /*Image a = new ImageIcon("扑克图Q版/1-1.png").getImage();
                g.drawImage(a,0,0,null);
				Image b = new ImageIcon("扑克图Q版/1-2.png").getImage();
				g.drawImage(b,30,0,null);
				Image c = new ImageIcon("扑克图Q版/2-1.png").getImage();
				g.drawImage(c,0,130,null);
				*/
